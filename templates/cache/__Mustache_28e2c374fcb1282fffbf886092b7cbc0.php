...
class __Mustache_28e2c374fcb1282fffbf886092b7cbc0 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF066c1d173f7a3a375c3b238ecffb74b($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionF066c1d173f7a3a375c3b238ecffb74b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
		<div class="panel panel-success">
		  <p class="panel-heading">Ajout réalisé</p>
		  <p class="panel-body">{{nom}} a été ajouté à vos contacts.</p>
		</div>
	';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
