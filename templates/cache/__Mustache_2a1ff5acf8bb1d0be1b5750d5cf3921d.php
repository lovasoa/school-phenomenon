...
class __Mustache_2a1ff5acf8bb1d0be1b5750d5cf3921d extends Mustache_Template
{
...
';
        $buffer .= $indent . '	</gd:name>
';
        $buffer .= $indent . '	<gd:organization rel="http://schemas.google.com/g/2005#work" primary="true">
';
...
';
        ...
        $buffer .= '" />
';
        $buffer .= $indent . '	<gd:phoneNumber rel=\'http://schemas.google.com/g/2005#work\' primary=\'true\'>
';
        $buffer .= $indent . '		';
        $value = $this->resolveValue($context->find('telephone'), $context, $indent);
        $buffer .= htmlspecialchars($value, 2, 'UTF-8');
        $buffer .= '
';
